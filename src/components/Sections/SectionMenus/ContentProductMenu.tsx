...
const ContentProductMenu = (props: ContentProductMenuProps) => {
  ...
  return (
    <Link to={`/`}>
      <div className="mx-3 flex items-center justify-between rounded-md bg-white px-2 py-3 shadow-sm transition-all duration-400 hover:scale-97 sm:w-11/12 sm:px-8">
